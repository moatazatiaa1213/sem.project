<?php
 ...
 // Notice that private connection information is *NOT* part of the
source
 ...
 try{
 $this->link = new PDO("mysql:host=".$host.";dbname=".$db, $user,
$pass);
...
PDO::ERRMODE_EXCEPTION);
 ...
 $sql = $this->link->prepare("INSERT INTO images (name, image) VALUES
(:name, :image);");
